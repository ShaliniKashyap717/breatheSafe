...
class Predictor:
    ...
    3: 0.05   # n95 (~95% filtration)
        ...
        # safe exposure time
        safe_hours = round(max(0.5, 12 * (1 - risk_score**2)), 1)
        ...
        if risk_score > 0.6:
            ...
            recommendation = f"Your lungs are absorbing {effective_pm25:.1f}µg/m³ of particulates. Limit outdoors to {safe_hours}h."
        elif risk_score > 0.3:
